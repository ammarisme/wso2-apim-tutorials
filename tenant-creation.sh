...
&lt;WorkFlowExtensions&gt;
    ...
    &lt;!--SubscriptionUpdate executor=&quot;org.wso2.carbon.apimgt.impl.workflow.SubscriptionUpdateWSWorkflowExecutor&quot;&gt;
         ...
         &lt;Property name=&quot;callbackURL&quot;&gt;https://localhost:9243/services/WorkflowCallbackService&lt;/Property&gt;
    &lt;/SubscriptionUpdate--&gt;
...
addUserWithRole "admin@railco.com" "admin" "apicreator" "Internal/creator" "Internal/everyone"
addUserWithRole "admin@railco.com" "admin" "apideveloper" "Internal/subscriber" "Internal/everyone"
addUserWithRole "admin@railco.com" "admin" "apipublisher" "Internal/publisher" "Internal/everyone"
sleep 3
